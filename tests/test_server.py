...
def test_compile_endpoint() -> None:
    components = [
        {"name": "TestRole", "type": "ROLE", "content": "You are a helpful assistant.", "priority": 10},
        {"name": "TestContext", "type": "CONTEXT", "content": "Use simple language.", "priority": 5},
    ]

    payload = {"user_input": "Explain quantum physics.", "variables": {}, "components": components, "max_tokens": 1000}
...
def test_compile_token_limit_exceeded() -> None:
    ...
    components = [
        {"name": "Critical", "type": "ROLE", "content": "Critical " * 10, "priority": 10},
        {"name": "Optional", "type": "CONTEXT", "content": "Optional " * 10, "priority": 1},
    ]
    ...
    payload = {"user_input": "Input", "variables": {}, "components": components, "max_tokens": 15}
...
def test_optimize_invalid_strategy() -> None:
    payload = {"text": "test", "limit": 10, "strategy": "invalid_strategy"}
    response = client.post("/v1/optimize", json=payload)
