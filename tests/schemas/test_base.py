...
def test_prompt_component_render_missing_keys() -> None:
    """Test render method raises UndefinedError when keys are missing."""
    import jinja2
...
def test_prompt_component_render_json_braces() -> None:
    """Test render method handles JSON braces without escaping needed for single braces."""
    # Jinja2 treats single braces as literals, so no need to escape them as {{ }}
