...
def test_create_command(cli_context: UserContext, components_file: str, capsys: pytest.CaptureFixture) -> None:
...
def test_create_command_error(cli_context: UserContext, capsys: pytest.CaptureFixture) -> None:
...
def test_resolve_command(cli_context: UserContext, capsys: pytest.CaptureFixture) -> None:
...
def test_resolve_command_with_vars(cli_context: UserContext, tmp_path: object, capsys: pytest.CaptureFixture) -> None:
    from pathlib import Path
    assert isinstance(tmp_path, Path)
...
def test_resolve_command_error(cli_context: UserContext, capsys: pytest.CaptureFixture) -> None:
...
def test_visualize_command(cli_context: UserContext, capsys: pytest.CaptureFixture) -> None:
...
def test_main_cli_create(components_file: str, capsys: pytest.CaptureFixture) -> None:
...
def test_main_cli_resolve(capsys: pytest.CaptureFixture) -> None:
...
def test_main_cli_visualize(capsys: pytest.CaptureFixture) -> None:
